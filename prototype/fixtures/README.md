...
V3 样本 [v3-region.snapshot.json](v3-region.snapshot.json) 来自提交 `3de81d513c8c2612604b33540df095e3e0644e2d` 的独立进程测试，为格式 2，包含环境与已开启门的状态。V3.1 用它验证格式 2 → 3 迁移。原始 GLB 样本与许可见 [meshes](meshes/README.md)。
