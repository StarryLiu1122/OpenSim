...
func _execute(operation: String, id: String, payload: Dictionary) -> Dictionary:
	...
	match operation:
		...
		"CreateObject", "UpdateObject", "DeleteObject", "SculptTerrain", "UpdateEnvironment", "RenameRegion", "SetRegionSpawn", "SetRegionSize", "SetObjectState", "GroupObjects", "UpdateGroup", "DuplicateGroup", "UngroupObjects", "DeleteGroup", "RemoveAsset":
