...
const MUTATIONS := ["CreateObject", "UpdateObject", "DeleteObject", "SculptTerrain", "UpdateEnvironment", "SetObjectState", "GroupObjects", "UpdateGroup", "DuplicateGroup", "UngroupObjects", "DeleteGroup", "RemoveAsset", "UploadAsset"]
