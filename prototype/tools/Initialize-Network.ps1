...
@{instance=$Directory;http="http://127.0.0.1:$($Port+1)/";https="https://localhost:$($Port+2)/";protocol='0.3';world_format=3;database_schema=4} | ConvertTo-Json | Set-Content (Join-Path $Directory 'instance.json') -Encoding utf8NoBOM
